...
namespace CrucibleBugTracker.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Message,Created,HasBeenViewed,RecipientId,SenderId,ProjectId,TicketId,NotificationTypeId")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Message,Created,HasBeenViewed,RecipientId,SenderId,ProjectId,TicketId,NotificationTypeId")] Notification notification)
        {
